...
if __name__ == '__main__':
    ...
    vocab_file = '/home/ado/桌面/CURE-master/data/vocabulary/vocabulary.txt'
    train_file = '/home/ado/桌面/CURE-master/data/data/training_bpe.txt'
    valid_file = '/home/ado/桌面/CURE-master/data/data/validation_bpe.txt'
    gpt_file = '/home/ado/桌面/CURE-master/data/models/code_gpt.pt'
    ...
    model_id = 1
    epochs = 5
    trainer.train(model_id, epochs, hyper_parameter, save_dir='/home/ado/桌面/CURE-master/data/models/')
